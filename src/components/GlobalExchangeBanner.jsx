...
export default function GlobalExchangeBanner({ onGetId }) {
  return (
    <section className="relative w-full overflow-hidden min-h-[460px] sm:min-h-[520px] md:min-h-[580px] flex items-center justify-center select-none bg-gradient-to-b from-[#05435A] via-[#043649] to-[#022430] border-y border-[#085a78]">
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4 h-full min-h-[420px] sm:min-h-[480px] md:min-h-[520px] pointer-events-none">
        ...
        >
          <div className="p-2.5 sm:p-3 rounded-sm bg-[#05435A]/95 border border-[#085a78] shadow-xl backdrop-blur-md text-left transition-transform hover:scale-105 hover:border-[#38bdf8]/60">
            <div className="flex items-center justify-between gap-2 mb-1 pb-1 border-b border-[#085a78]">
              ...
              <span className="text-[9px] font-mono text-emerald-400 font-bold bg-emerald-950/70 px-1 py-0.2 rounded-xs border border-emerald-600/40">LIVE</span>
            </div>
            <div className="text-[11px] sm:text-xs font-semibold text-[#edd315] flex items-center gap-1 mb-0.5">
              <Zap className="w-3 h-3 text-[#edd315]" />
              <span>Instant Odds Updates</span>
            </div>
            <p className="text-[9px] sm:text-[10px] text-slate-200 leading-tight">
              Premier League & UEFA Synced
            </p>
          </div>
          <div className="flex items-center justify-center -mt-0.5">
            <div className="w-px h-3 bg-gradient-to-b from-[#38bdf8]/70 to-transparent" />
          </div>
        </div>
        ...
        >
          <div className="p-2.5 sm:p-3 rounded-sm bg-[#05435A]/95 border border-[#085a78] shadow-xl backdrop-blur-md text-left transition-transform hover:scale-105 hover:border-[#edd315]/60">
            <div className="flex items-center justify-between gap-2 mb-1 pb-1 border-b border-[#085a78]">
              <div className="flex items-center gap-1.5">
                <span className="w-1.5 h-1.5 rounded-full bg-[#edd315] animate-pulse" />
                <span className="font-serif-display text-[10px] sm:text-[11px] font-bold text-white uppercase tracking-wider">Dubai Hub</span>
              </div>
              <span className="text-[9px] font-mono text-[#edd315] font-bold bg-[#032b3a] px-1 py-0.2 rounded-xs border border-[#edd315]/40">24/7 VIP</span>
            </div>
            <div className="text-[11px] sm:text-xs font-semibold text-[#edd315] flex items-center gap-1 mb-0.5">
              <ShieldCheck className="w-3 h-3 text-[#edd315]" />
          ...
          <div className="flex items-center justify-center -mt-0.5">
            <div className="w-px h-3 bg-gradient-to-b from-[#edd315]/70 to-transparent" />
          </div>
        </div>
        ...
        >
          <div className="p-2.5 sm:p-3 rounded-sm bg-[#05435A]/95 border border-[#085a78] shadow-xl backdrop-blur-md text-left transition-transform hover:scale-105 hover:border-[#38bdf8]/60">
            <div className="flex items-center justify-between gap-2 mb-1 pb-1 border-b border-[#085a78]">
              ...
              <span className="text-[9px] font-mono text-emerald-400 font-bold bg-emerald-950/70 px-1 py-0.2 rounded-xs border border-emerald-600/40">MATCHED</span>
            </div>
            <div className="text-[11px] sm:text-xs font-semibold text-[#edd315] flex items-center gap-1 mb-0.5">
              <Activity className="w-3.5 h-3.5 text-[#edd315]" />
        ...
        >
          <div className="p-2.5 sm:p-3 rounded-sm bg-[#05435A]/95 border border-[#085a78] shadow-xl backdrop-blur-md text-left transition-transform hover:scale-105 hover:border-[#edd315]/60">
            <div className="flex items-center justify-between gap-2 mb-1 pb-1 border-b border-[#085a78]">
              ...
              <span className="text-[9px] font-mono text-[#edd315] font-bold bg-[#032b3a] px-1 py-0.2 rounded-xs border border-[#edd315]/40">ONLINE</span>
            </div>
            <div className="text-[11px] sm:text-xs font-semibold text-[#edd315] flex items-center gap-1 mb-0.5">
              <Zap className="w-3 h-3 text-[#edd315]" />
        ...
        >
          <div className="p-2.5 sm:p-3 rounded-sm bg-[#05435A]/95 border border-[#085a78] shadow-xl backdrop-blur-md text-left transition-transform hover:scale-105 hover:border-[#38bdf8]/60">
            <div className="flex items-center justify-between gap-2 mb-1 pb-1 border-b border-[#085a78]">
              ...
              <span className="text-[9px] font-mono text-emerald-400 font-bold bg-emerald-950/70 px-1 py-0.2 rounded-xs border border-emerald-600/40">ACTIVE</span>
            </div>
            <div className="text-[11px] sm:text-xs font-semibold text-[#edd315] flex items-center gap-1 mb-0.5">
              <ShieldCheck className="w-3 h-3 text-[#edd315]" />
